...
public class UserServiceImpl implements UserService {
    ...
    public String findByPhoneAndPwd(String phone, String pwd) {
        ...
        User user = userMapper.findByPhoneAndPwd(phone, DigestUtils.md5DigestAsHex(pwd.getBytes(StandardCharsets.UTF_8)));
